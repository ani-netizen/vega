    ...
    <div className="min-h-screen bg-gray-100 px-4 py-8 flex flex-col items-center justify-center">
      <div className="w-full max-w-3xl text-center">
        ...
        <p className="text-xl mb-8">
          A platform that empowers students to manage their placement
          opportunities and connect with companies seamlessly.
        </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
        <div className="bg-white rounded-md shadow-md p-4">
          ...
          <ul className="list-disc space-y-2">
            <li>
              Company A - Software Engineer (Internship) - Deadline: May 31,
              2024
            </li>
            <li>
              Company B - Data Analyst (Full-time) - Deadline: June 15, 2024
            </li>
          </ul>
        </div>
        <div className="bg-white rounded-md shadow-md p-4">
