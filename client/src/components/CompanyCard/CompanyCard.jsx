    ...
    <Link to={`/company/${company._id}`}>
      <div className="w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 shadow overflow-hidden">
        <div className="flex flex-col  p-4">
          ...
          <p className="mb-3 text-gray-500 dark:text-gray-300 mt-4">
            <strong className="p-4 text-blue-600 rounded-ss-lg hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-700 dark:text-blue-500">
              Description:
            </strong>
            {company.description}
          </p>
